          ...
          <div className="p-4">
            {searchValue && (
              <div>
                <Link
                  href={`/map`}
                  className="flex justify-between items-center py-[6px] px-[10px] rounded-[7px] bg-mainColor/5"
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-xs font-medium text-dolphin my-5">
                    ...
                    <div className="space-y-2">
                      {filteredProducts.map((item) => (
                        <Link
                          href={`/`}
                          key={item.id}
                          className={`flex items-center gap-[10px] px-[10px] py-[6px] rounded-lg cursor-pointer transition-colors ${
                            item.selected
                              ? "bg-mainColor/5"
