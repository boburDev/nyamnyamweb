...
import { useNotificationById } from "@/hooks";
      ...
      <div className="mt-[30px] pb-[150px]">
        ...
        <div className="bg-white border border-plasterColor rounded-[20px] px-4 py-3 xl:p-[30px]">
          ...
          <div className="prose max-w-none">
            <p className="text-xs sm:text-sm xl:text-[16px] leading-7 text-dolphin whitespace-pre-wrap">
