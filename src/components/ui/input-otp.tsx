...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      data-filled={!!char} // qo‘shimcha atribut
      className={cn(
        ...
        "data-[active=true]:z-10 data-[active=true]:ring-[1px] data-[active=true]:border-ring data-[active=true]:ring-ring/50",
        "aria-invalid:border-destructive data-[active=true]:aria-invalid:border-destructive",
        char ? "border-mainColor" : "",
        className
      )}
      {...props}
    >
